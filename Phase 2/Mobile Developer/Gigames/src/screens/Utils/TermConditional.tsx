...
interface TermConditionalPagesProps {}
const TermConditionalPages: React.FC<TermConditionalPagesProps> = () => {
...
export default TermConditionalPages;
